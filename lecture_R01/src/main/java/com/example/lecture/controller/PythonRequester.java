...
public class PythonRequester {
    final static Logger log =
            LoggerFactory.getLogger(com.example.lecture.controller.PythonRequester.class);
    ...
    public ModelAndView doRequestPythonRest(Model model) {
        ...
        // RestFUL 서버에 요청을 보내 받아온 정보가 result인데, 이 정보를 msg라는 속성 값에 할당했다
        // 그러므로 사용하자고 한다면 html 코드에서 msg를 활용해야 한다.
